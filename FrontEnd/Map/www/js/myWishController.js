var myWishModule = angular.module('myWish.controllers', ['ionic']);

myWishModule.controller('MyWishCtrl', function ($scope, $state, $ionicHistory, $http) {
...
myWishModule.controller("TypeController2", function ($scope, $http) {

  console.log("进入myWishModule.TypeController");
  this.tab = 1;
