var myFootprintModule = angular.module('myFootprint.controllers', ['ionic']);

myFootprintModule.controller('MyFootprintCtrl', function ($scope, $state, $ionicHistory, $http) {
  sortT = "come";
...
myFootprintModule.controller("TypeController1", function ($scope, $http) {
