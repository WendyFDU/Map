...
//})
  .controller('LoginCtrl', function($scope, $rootScope, $state, $ionicPopup, $http) {
    ...
    $scope.signIn = function (loginForm) {
      ...
      if (loginForm.$valid) {
        $http({
          method: 'POST',
          url: "http://localhost:8080/server/user/logining",
  ...
  .controller('RegisterCtrl', function($scope, $rootScope, $state, $ionicPopup, $http) {
    $scope.register = {};
    $scope.signIn = function (registerForm) {
      ...
      if (registerForm.$valid) {
        $http({
          method: 'POST',
          url: "http://localhost:8080/server/user/registering",
          params: {"username" : $scope.register.username,"userpassword" : $scope.register.password,"userintro":$scope.register.intro,"userface":"xxx"},
          headers: {
            'Content-Type': 'application/json',
            'Accept' : 'application/json',
            'Access-Control-Allow-Origin': '*',
